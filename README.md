...
= = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = = [ Обработчик событий ]= = = = = = = = = = = = = = = = = = = = = = = = = = = = =
В обльших приложениях, где много разных сервисов, модулей... требуется модель согласованного и гарантированного способа для реализации обработчика событий.
...
Таким образом (абстрактный контролер) 'EventBus' выступает в роли шлюза между 'ActivityManager' и 'PlaceHistoryHandler' - связывает 2-е независимые части приложения...:
